...
2. ⚡ **[n8n Automation Workflow](./blinkit%20n8n%20workflow)**: An automated batch-processing review analysis pipeline (`workflow.json`, `samplereview.csv`, `image.png`).
...
├── blinkit n8n workflow/          # n8n workflow files (workflow.json, CSV, Dockerfile, etc.)
│   ├── workflow.json              # n8n workflow definition
│   ├── samplereview.csv           # Sample review dataset
│   ├── image.png                  # n8n workflow diagram
│   ├── Dockerfile                 # Docker configuration for n8n deployment
│   └── README.md                  # n8n Workflow detailed documentation
...
Detailed setup and free deployment instructions are located in the **[n8n Workflow README](./blinkit%20n8n%20workflow/README.md)**.
